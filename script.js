...
const DB = {
  ...
  feather:     {name:"Feather", emoji:"🍂", building:"Farm Animals", time:90, ingredients:[]},
  ...
  cookie:       {name:"Cookie", emoji:"🍪", building:"Bakery", time:40, ingredients:[{id:"wheat", qty:2},{id:"sugar", qty:1}]},
  bagel:        {name:"Bagel", emoji:"🥯", building:"Bakery", time:20, ingredients:[{id:"wheat", qty:2},{id:"egg", qty:1}]},
  pizza:        {name:"Pizza", emoji:"🍕", building:"Bakery", time:60, ingredients:[{id:"bread", qty:1},{id:"cheese", qty:1},{id:"tomato", qty:1}]},
  potato_bread: {name:"Potato Bread", emoji:"🍞", building:"Bakery", time:60, ingredients:[{id:"wheat", qty:1},{id:"potato", qty:1},{id:"egg", qty:1}]},
  banana_bread: {name:"Banana Bread", emoji:"🍞", building:"Bakery", time:60, ingredients:[{id:"wheat", qty:1},{id:"banana", qty:1},{id:"egg", qty:1},{id:"butter", qty:1}]},
  seafood_pizza:{name:"Seafood Pizza", emoji:"🍕", building:"Bakery", time:60, ingredients:[{id:"wheat", qty:1},{id:"cheese", qty:1},{id:"fish", qty:1},{id:"shrimp", qty:1}]},

  // DAIRY FACTORY
  cream:  {name:"Cream", emoji:"🍦", building:"Dairy Factory", time:10, ingredients:[{id:"milk", qty:2}]},
  butter: {name:"Butter", emoji:"🧈", building:"Dairy Factory", time:20, ingredients:[{id:"milk", qty:3}]},
  cheese: {name:"Cheese", emoji:"🧀", building:"Dairy Factory", time:40, ingredients:[{id:"milk", qty:4}]},
  yogurt: {name:"Yogurt", emoji:"🥣", building:"Dairy Factory", time:30, ingredients:[{id:"milk", qty:2},{id:"strawberry", qty:2}]},
  peach_yogurt: {name:"Peach Yogurt", emoji:"🥣", building:"Dairy Factory", time:30, ingredients:[{id:"milk", qty:2},{id:"peach", qty:2}]},

  // SUGAR FACTORY
  sugar: {name:"Sugar", emoji:"🧊", building:"Sugar Factory", time:20, ingredients:[{id:"sugarcane", qty:3}]},
  syrup: {name:"Syrup", emoji:"🧂", building:"Sugar Factory", time:20, ingredients:[{id:"sugarcane", qty:3}]},
  ...
  fabric: {name:"Fabric", emoji:"🧦", building:"Textile Factory", time:30, ingredients:[{id:"silk", qty:2}]},
  nylon:  {name:"Nylon Thread", emoji:"🧵", building:"Textile Factory", time:50, ingredients:[{id:"rubber_tree", qty:3}]},

  // TAILOR SHOP
  shirt:   {name:"Shirt", emoji:"👕", building:"Tailor Shop", time:60, ingredients:[{id:"cotton_fabric", qty:2}]},
  sweater: {name:"Sweater", emoji:"🥼", building:"Tailor Shop", time:60, ingredients:[{id:"yarn", qty:2}]},
  coat:    {name:"Coat", emoji:"👚", building:"Tailor Shop", time:60, ingredients:[{id:"fabric", qty:1},{id:"cotton_fabric", qty:1}]},
  dress:   {name:"Dress", emoji:"👗", building:"Tailor Shop", time:90, ingredients:[{id:"cotton_fabric", qty:3},{id:"fabric", qty:2}]},
  hat:     {name:"Tyrolean Hat", emoji:"🧢", building:"Tailor Shop", time:90, ingredients:[{id:"fabric", qty:3},{id:"cotton", qty:2}]},
  ...
  peach_marmalade: {name:"Peach Marmalade", emoji:"🍑", building:"Jam Factory", time:150, ingredients:[{id:"peach", qty:3}]},
  ...
  grape_jelly: {name:"Grape Jelly", emoji:"🍇", building:"Jam Factory", time:210, ingredients:[{id:"grapes", qty:3}]},
